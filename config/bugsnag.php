...
return [
    ...
    */
    ...
    'filters' => empty(env('BUGSNAG_FILTERS')) ?
        ['password'] : explode(',', str_replace(' ', '', env('BUGSNAG_FILTERS'))),
    ...
    */
    ...
    'release_stage' => env('BUGSNAG_RELEASE_STAGE', env('APP_ENV')),
    ...
    */
    ...
    'notify_release_stages' => empty($BNRS = env('BUGSNAG_NOTIFY_RELEASE_STAGES', 'production,staging')) ?
        null :
        explode(',', str_replace(' ', '', $BNRS)),

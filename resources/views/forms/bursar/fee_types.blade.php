											...
											<div class="modal fade" id="edit{{ $i->id }}" tabindex="-1" role="basic" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form action="/dashboard/update-fee-type/{{ $i->id }}" method="POST" class="horizontal-form">
																...
																<div class="row">
																	<div class="col-md-5">
																		...
																		<div class="form-group">
																			...
																			<input type="text" value="{{ $i->name }}" id="Name" class="form-control" placeholder="eg: Tution" name="name">
																		</div>
																	</div>
																	...
																	<div class="col-md-7">
																		<div class="form-group">
																			...
																			<textarea rows="8" class="form-control" name="description" placeholder="Short description of Fee">{{ $i->description }}</textarea>
											...
											<div class="modal fade" id="delete{{ $i->id }}" tabindex="-1" role="basic" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-footer">
															<button type="button" class="btn default" data-dismiss="modal">Close</button>
															<a href="/dashboard/delete-fee-type/{{ $i->id }}" class="btn red">Delete</a>
														</div>
													</div>
												</div>
											</div>
															...
															<div class="form-body">
																<div class="row">
																	<div class="col-md-5">
																		...
																		<div class="form-group">
																			<label class="control-label">Name</label>
																			<input type="text" value="" id="sessionName" class="form-control" placeholder="eg: Tution" name="name">
																		</div>
																	</div>
																	...
																	<div class="col-md-7">
																		<div class="form-group">
																			<label class="control-label">Description</label>
																			<textarea rows="4" class="form-control" name="description" placeholder="Short description of Fee"></textarea>

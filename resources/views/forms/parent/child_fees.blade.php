                    ...
                    <div class="portlet-title">
                        <div class="caption font-blue-sharp">
                            <span class="caption-subject"
                                  style="text-transform: uppercase;"> {{ $student->firstname }} {{ $student->lastname }}</span>
                            <p style="color: #666">
                                <small>level: {{ $level->levelname }}</small>
                            </p>
                        </div>
                        <div class="actions">
                            <h3>
                                <span class="muted">Term: {{ $active_session->current_term }} </span>| {{ $active_session->name }}
                            </h3>
                        </div>
                    </div>
                    <div class="portlet-body" id="div1">
                        @if ($payment)
                            <center>
                                ...
                                ?>
                                <a href="{{ route('pdfview',['download'=>'pdf', 'fee_data' => $fee_data]) }}">Download
                                    Reciept</a>
                            </center>
                        @else
                            ...
                            <div class="row" style="margin-top: 10vh">
                                <div class="col-md-4">
                                    <div class="well">
                                        <address>
                                            ...
                                            Lagos<br>
                                            <abbr title="Phone">P:</abbr> (234) 8094826000
                                        </address>
                                        <address>
                                ...
                                <div class="col-md-5 col-md-offset-3 invoice-block">
                                    ...
                                    <br>
                                    <a class="btn btn-lg blue hidden-print margin-bottom-5" onclick="window.print();">
                                        <i class="fa fa-print"></i> Print
                                    </a>
                                    <form>
                                        <meta name="csrf-token" content="{{ csrf_token() }}">
                                        <script src="https://js.paystack.co/v1/inline.js"></script>
                                        <button class="btn btn-lg green hidden-print margin-bottom-5" type="button"
                                                onclick="payWithPaystack()"><i class="fa fa-lock"></i> Process Payment
                                            Securely
                                        </button>
                                        <button class="btn btn-lg green hidden-print margin-bottom-5" type="button"
                                                onclick="boom()"> Simulate
                                        </button>
                                    </form>
                                </div>
                            </div>

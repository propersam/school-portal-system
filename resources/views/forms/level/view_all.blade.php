							...
							<div class="modal fade" id="edit{{ $i->id }}" tabindex="-1" role="basic" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<form action="/dashboard/update-level/{{ $i->id }}" method="POST" class="horizontal-form">
												...
												<div class="row">
													<div class="col-md-5">
														...
														<div class="form-group">
															...
															<input type="text" value="{{ $i->levelname }}" id="sessionName" class="form-control" placeholder="eg: Kg1" name="levelname">
														</div>
													</div>

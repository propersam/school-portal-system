    ...
    <form class="login-form" method="POST" action="{{ route('password.request') }}">
        ...
        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <div class="input-icon">
                ...
                <input id="email" class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Username" name="email" value="{{ $email or old('email') }}" required autofocus>
            </div>
            @if ($errors->has('email'))
        ...
        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
            ...
            <div class="input-icon">
                <i class="fa fa-lock"></i>
                <input id="password-confirm" class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirm Password" name="password_confirmation" required>

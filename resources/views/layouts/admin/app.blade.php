						...
						{{ Auth::user()->name }} </span>
                            @if (Auth::user()->photo)
                                <img alt="" class="img-circle"
                                     src="{{asset('uploads/profile_photos/'.Auth::user()->photo) }}"/>
                            @else
...
<script type="text/javascript"
        src="{{ asset('assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js')}}"></script>
<script type="text/javascript"
        src="{{ asset('assets/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js')}}"></script>
...
<script type="text/javascript"
        src="{{ asset('assets/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js')}}"></script>
<script type="text/javascript"
...
<script src="{{ asset('assets/scripts/quick-sidebar.js')}}" type="text/javascript"></script>
...
<script src="{{ asset('js/json-export-excel.js')}}"></script>

...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="#">
			<img src="/assets/admin/layout4/img/logo-big.png" alt="logo" height="80px" width="200px" style="padding: 10px" class="logo-sdefault"/>
			</a>
...
<script type="text/javascript">
    ...
    (function () {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/5b584078e21878736ba2495b/default';
        s1.charset = 'UTF-8';

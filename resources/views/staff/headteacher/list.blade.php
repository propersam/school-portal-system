						...
						<div class="portlet-body">
							...
							<div class="table-scrollable">
								...
								<tr>
                                    ...
                                    <div class="modal fade class_modal" id="view{{ $i->id }}" tabindex="-1" role="basic"
                                         aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">View Head Teacher</h4>
                                                </div>
                                    ...
                                    <div class="modal fade class_modal" id="edit{{ $i->id }}" tabindex="-1" role="basic"
                                         aria-hidden="true">
                                        <div class="modal-dialog">
                                            <form action="/dashboard/update-headteacher/{{ $i->id }}" method="POST"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="/dashboard/delete-headteacher/{{ $i->user_id }}"

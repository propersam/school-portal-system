                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn blue" data-toggle="modal"
                                                   href="#view{{ $loop->iteration }}">
                                                    View Staff</a>

                                                <a class="btn yellow" data-toggle="modal"
                                                   href="#edit{{ $loop->iteration }}">
                                                    Edit Staff</a>

                                                <a class="btn red" data-toggle="modal"
                                                   href="#delete{{ $loop->iteration }}">
                                                    Delete </a>
                                            </td>
                                            <div class="modal fade class_modal" id="view{{ $loop->iteration }}"
                                            ...
                                            <div class="modal fade class_modal" id="edit{{ $loop->iteration }}"
                                                 tabindex="-1" role="basic" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <form action="/dashboard/update-staff/{{ $i->id }}" method="POST"
                                                                ...
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="hidden" name="staff_role"
                                                                                   value="{{ $i->user->role }}">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Firstname</label>
                                                                                <input type="text" id="firstName"
                                                                                       class="form-control"
                                                                                       placeholder="Enter Staff's Firstname"
                                                                                       name="firstname"
                                                                                       value="{{ $i->firstname }}">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" id="lastName"
                                                                                       class="form-control"
                                                                                       placeholder="Enter Staff's LastName"
                                                                                       name="lastname"
                                                                                       value="{{ $i->lastname }}">
                                                                                <!-- <span class="help-block">
                                                                                This is inline help </span> -->
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Employment
                                                                                    Date</label>
                                                                                <input class="form-control"
                                                                                       data-provide="datepicker"
                                                                                       name="employmentdate"
                                                                                       value="{{ $i->employmentdate }}">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="note note-warning">
                                                                <p>Please note that this action is <b>irreversible</b>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="/dashboard/delete-staff/{{ $i->user_id }}"
